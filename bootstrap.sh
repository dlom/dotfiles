...
function dotfiles() {
	git ls-files | rsync --files-from=- --exclude "bootstrap.sh" --exclude "README.md" --exclude "LICENSE" --no-perms --archive --verbose --checksum --human-readable --prune-empty-dirs "$@" ./ $HOME/
}
